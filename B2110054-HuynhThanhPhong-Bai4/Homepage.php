...
topright"></i>
            ...
            <h3 class="w3-wide"><b>
                    ...
                    if (isset($_SESSION['fullname'])) {
                        echo 'Chào bạn ' . htmlspecialchars($_SESSION['fullname']); // Sử dụng htmlspecialchars để bảo vệ khỏi XSS
                    } else {
                        echo 'Chào bạn, vui lòng đăng nhập.';
                        exit();
                    }
                    ...
                    if (isset($_SESSION['id'])) {
                        $stmt = $conn->prepare("SELECT img_profile FROM customers WHERE id = ?");
                        $stmt->bind_param("i", $_SESSION['id']); // "i" cho kiểu số nguyên
                        $stmt->execute();
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo '<img src="./uploads/' . htmlspecialchars($row['img_profile']) . '" alt="Ảnh profile">';
                        } else {
                            echo "Không tìm thấy ảnh profile.";
                        }
        ...
        <footer class="w3-padding-64 w3-light-grey w3-small w3-center" id="footer">
            <div class="w3-row-padding">
                ...
                <div class="w3-col s4">
                    ...
                    <p><a href="#">Return</a></p>
                    <p><a href="#">Help</a></p>
                    <p><a href="thoat.php">Log out</a></p>
                    <p><a href="formsuamk.php">Đổi mật khẩu</a></p>
                </div>
